...
**Audit mode:** fresh code audit plus current automated UI evidence; no human perceptual or assistive-technology result is claimed
...
| 2. Visuals | 3/4 | Responsive hierarchy, modal structure, landmarks, and long-content geometry are automated, but a fresh rendered/perceptual review was unavailable and remains human-needed. |
...
| 6. Experience Design | 3/4 | Loading, empty, error, conflict, authentication, unknown-delivery, disabled, recovery, modal, and responsive flows are automated; VoiceOver and real password-manager behavior remain unverified by a human. |
...
These are human validation gaps, not known implementation defects. No automated UI-contract defect remains in this re-audit.
...
- **WARNING:** No Keepling server was running for fresh screenshots, so visual allocation, perceived hierarchy, wrapping quality, and calmness cannot earn 4/4 without the preserved human perceptual review.
...
- **WARNING:** Real VoiceOver announcement quality and real password-manager/OS integration remain human-needed. DOM automation is not treated as proof of those external experiences (`01-VERIFICATION.md:213`).
